...
class HomePostCell: UICollectionViewCell {
    ...
    fileprivate func setupActionButtons() {
        ...
        bookmarkButton.anchor(top: photoImageView.bottomAnchor, left: nil, bottom: nil, right: rightAnchor, paddingTop: 0, paddingLeft: 8, paddingBottom: 0, paddingRight: 0, width: 40, height: 50)
    }
