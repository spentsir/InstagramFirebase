...
//  InstagramFIrebase
//
//  Created by Spencer Cawley on 8/2/18.
...
class LoginController: UIViewController {
    ...
    let logoContainerView: UIView = {
        ...
        // putting Instagram inside the logoContainerView
    ...
    // Changes login button color once text fields are filled out
    ...
    @objc func handleLogin() {
        ...
        Auth.auth().signIn(withEmail: email, password: password) { (user, error) in
            ...
            if let error = error {
                print("Failed to sign in w/ email: \(error.localizedDescription)")
                return
            }
